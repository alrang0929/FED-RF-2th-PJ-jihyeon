...
import * as menu from "../data/common_data";
    ...
    <>
      ...
      <header id="header-area">
        ...
        <div className="roll-ben">
          <ul className="">
            {menu.rollbanData.map((v, i) => (
              <li className="cont" data-idx={i}>
                <a href="">{v}</a>
              </li>
            ))}
          </ul>
        ...
        <div className="fx-box" id="gnb-area">
          ...
          <div className="fx-box" id="L-menu-wrap">
            <div className="menu-inner fx-box">
              {menu.gnbData.map((v, i) => (
                <ul className="sub-menu">
                  <a href="">1차 메뉴</a>
                  <li className="sub-inner">
                      <a href="">2차 메뉴</a>
                      <a href="">2차 메뉴</a>
                      <a href="">2차 메뉴</a>
                  </li>
          ...
          <div className="logo">
            <h1>
              <a href="">
                <img src="../images/logo_en.png" alt="슬밋 로고" />
              </a>
            </h1>
          </div>
          {/* <!-- R menu --> */}
